    ...
    <footer className='flex justify-center pt-6 sm:pt-10 md:pt-14 pb-[32px]'>
      <div className="wrapper w-[97%] phone-sm:w-11/12 lg:w-4/5 p-3 space-y-14">
        <div className='flex flex-col gap-y-8 sm-lg:gap-y-0 sm-lg:flex-row sm-lg:justify-between'>
          ...
          {/* Links */}
          <div className='links grid gap-cols-1 xs:grid-cols-2 gap-y-6 phone-sm:gap-y-0 phone-sm:grid-cols-3 phone-sm:gap-x-8 phone-sm:justify-items-center sm:gap-x-16  sm:justify-items-start sm-lg:grid-cols-[repeat(3,max-content)] sm-lg:gap-x-12 md-lg:gap-x-16 lg:gap-x-20'>
